...
- (void)tabBar:(UITabBar *)tabBar didSelectItem:(UITabBarItem *)item
{
    if (item.tag == 0) {
        ...
        self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"通讯录" style:UIBarButtonItemStyleBordered
                                                                                 target:self action:@selector(gotoContactVC)];
    }else {
        self.title = @"设置";
        self.navigationItem.rightBarButtonItem = nil;
    }
...
- (void)setupSubviews
{
    ...
    homeVC.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"首页"
                                                           image:nil
                                                             tag:0];
    [homeVC.tabBarItem setFinishedSelectedImage:[UIImage imageNamed:@"home_s.png"]
                         withFinishedUnselectedImage:[UIImage imageNamed:@"home_us.png"]];
    
    //2
    VideoViewController *videoVC = [VideoViewController new];
    videoVC.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"视频"
                                                      image:nil
                                                        tag:1];
    [videoVC.tabBarItem setFinishedSelectedImage:[UIImage imageNamed:@"home_s.png"]
                    withFinishedUnselectedImage:[UIImage imageNamed:@"home_us.png"]];
    ...
    _chatListVC.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"会话"
                                                           image:nil
                                                             tag:2];
    [_chatListVC.tabBarItem setFinishedSelectedImage:[UIImage imageNamed:@"home_s.png"]
                         withFinishedUnselectedImage:[UIImage imageNamed:@"home_us.png"]];
    
    //4
    UserSettingViewController *settingVC = [UserSettingViewController new];
    settingVC.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"设置"
                                                       image:nil
                                                         tag:3];
    [settingVC.tabBarItem setFinishedSelectedImage:[UIImage imageNamed:@"home_s.png"]
                     withFinishedUnselectedImage:[UIImage imageNamed:@"home_us.png"]];
    
    self.viewControllers = @[homeVC, videoVC, _chatListVC,settingVC];
    self.tabBar.tintColor = tabbarColor;
    [self.tabBar setSelectedImageTintColor:tabbarColor];
